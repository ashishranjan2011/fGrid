...
model_details=model.fit(data_train,box_train,batch_size=128,epochs=100,shuffle=False,validation_split=0.1,callbacks=[lr_scheduler,lr_reducer,checkpoint],verbose=1)

model.save('model.h5')

scores=model.evaluate(data_test,box_test[:,:4],verbose=1)
